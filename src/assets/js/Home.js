        ...
        return (
            <React.Fragment>
                ...
                <div className="container container--acceuil">
                    <div className="row">
                        <div className="pl-lg-5 col-lg-7 col-md-6 col-sm-6 col-11 acceuil--left">
                            <div className="acceuil--content">
                                <span>Hello je suis</span>
                                <h1>Caroline van Aerschot</h1>
                                <h4>Graphic designer ✏️/ Web designer 🖱️/ Web developper 👩🏻‍💻
                                </h4>
                                <button data-hover="Merci!"><div>contactez-moi</div></button>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6 acceuil--right">
                            <div className="acceuil--content">
                                <img
                                    ...
                                    className="bob-y img-fluid Me__VectorAfter"
                                    alt="Me__VectorAfter"/>
                                <Blob/>
                                <img
